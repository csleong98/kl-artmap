...
export const mockLocations: Location[] = [
  {
    ...
    imageUrl: '/images/locations/national-art-gallery.JPG',
  ...
  },
  {
    ...
    imageUrl: '/images/locations/ilham-tower.JPG',
  ...
  },
  {
    ...
    address: 'Jalan Lembah, Tasik Perdana, 50480 Kuala Lumpur',
    imageUrl: '/images/locations/textile-museum.jpeg',
    nearestStations:['KL Sentral', 'Muzium Negara MRT'],
    admission: 'paid',
    details: {
      overview: {
  ...
  },
  {
    ...
    address: 'Jalan Lembah, Tasik Perdana, 50480 Kuala Lumpur',
    imageUrl: '/images/locations/bsas.JPEG',
    nearestStations:['KL Sentral', 'Muzium Negara MRT'],
    admission: 'free',
    details: {
      overview: {
  ...
  },
  {
    ...
    imageUrl: '/images/locations/UR-MU-TunHSLee.JPEG',
